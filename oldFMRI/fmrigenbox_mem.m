%  fmrigenbox_mem.m  -- May 1998
%
%  FORMAT:	    fmrigenbox_mem
%__________________________________________________________
%
%  This program generates a user-defined boxcar for the memory
...
boxparam=input('i.e., [n,Tinit,T0,T1,T2,T3,T4,Ti]:   ');

bx=boxcar_mem(boxparam(1),boxparam(2),boxparam(3),boxparam(4),...
    boxparam(5),boxparam(6),boxparam(7),boxparam(8));
